...
export default function MonitorScreen() {
  ...
  // Animate audio level bar based on buffer health
  useEffect(() => {
    if (isStreaming) {
      const level = Math.min(audioStats.bufferHealth * 100, 100);
  ...
  }, [audioStats.bufferHealth, isStreaming]);
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        ...
        <View style={[styles.card, { backgroundColor: colors.background }]}>
          ...
          <View style={styles.audioVisualizerContainer}>
            <View style={[styles.audioLevelBarBackground, { backgroundColor: colors.icon + '20' }]}>
              <Animated.View
                style={[
                  styles.audioLevelBar,
                  {
                    backgroundColor: isStreaming ? '#4CAF50' : colors.icon,
            ...
            <ThemedText style={styles.audioLevelText}>
              {isStreaming
                ? `Buffer: ${(audioStats.bufferHealth * 1000).toFixed(0)}ms`
                : 'Not streaming'}
            </ThemedText>
          </View>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: colors.background }]}>
          ...
          <View style={styles.volumeControl}>
            <IconSymbol size={20} name="speaker.fill" color={colors.icon} />
            <Slider
            ...
            />
            <IconSymbol size={20} name="speaker.wave.3" color={colors.icon} />
          </View>
        ...
        <View style={[styles.card, { backgroundColor: colors.background }]}>
          ...
          <View style={styles.statsGrid}>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Frames Received</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {audioStats.framesReceived.toLocaleString()}
              </ThemedText>
            </View>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Packet Loss</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {(audioStats.packetLossRate * 100).toFixed(2)}%
              </ThemedText>
            </View>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Buffer Health</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {(audioStats.bufferHealth * 1000).toFixed(0)}ms
              </ThemedText>
            </View>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Sample Rate</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {audioConfig?.sampleRate || 0} Hz
              </ThemedText>
            </View>
          </View>
        </View>
        ...
        <View style={[styles.card, { backgroundColor: colors.background }]}>
          <View style={styles.cardHeader}>
            ...
            <TouchableOpacity
              onPress={refreshDeviceInfo}
              style={styles.refreshButton}
            >
              <IconSymbol size={16} name="arrow.clockwise" color={colors.tint} />
            </TouchableOpacity>
          </View>
          <View style={styles.statsGrid}>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Battery Level</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {audioStats.batteryLevel}%
              </ThemedText>
            </View>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Uptime</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {formatUptime(audioStats.uptime)}
              </ThemedText>
            </View>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Firmware</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {deviceInfo?.firmwareVersion ? getFirmwareVersion(deviceInfo.firmwareVersion) : 'N/A'}
              </ThemedText>
            </View>
            <View style={styles.statItem}>
              <ThemedText style={styles.statLabel}>Audio Format</ThemedText>
              <ThemedText type="defaultSemiBold" style={styles.statValue}>
                {audioConfig?.bitDepth || 0}-bit
              </ThemedText>
            </View>
          </View>
        </View>
